        ...
        <footer className="footer-editorial">
            <div className="container">
                ...
                <div className="footer-cta-section">
                    <a
                        href="https://wa.me/919182100688?text=Hi%20Tarun,%20I%20saw%20the%20Veloura%20website%20and%20would%20like%20to%20discuss%20a%20project."
                        target="_blank"
                ...
                {/* Artistic Signature */}
                <p className="footer-signature">Crafted with care by Tarun</p>
            </div>
        </footer>
    );
}
